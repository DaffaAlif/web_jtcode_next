...
const FormEditCustomer = () => {
  ...
  const { printer_id, code, name, location, status, notes } = router.query
  ...
  const handleSubmit = e => {
    ...
    axios
      .post(`https://dev.iotaroundyou.my.id/api/printer/update`, formData, {
        headers: {
      ...
      .then(response => {
        setSuccess(true)
        setError('Update Success! Redirecting you to Printers Page')
