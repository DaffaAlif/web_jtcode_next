...
const FormEditCustomer = () => {
  ...
  const { instrument_id, code, name, status, notes } = router.query
  ...
  const handleSubmit = e => {
    ...
    axios
      .post(`https://dev.iotaroundyou.my.id/api/instrument/update`, formData, {
        headers: {
      ...
      .then(response => {
        setSuccess(true)
        setError('Update Success! Redirecting you to Instrument Page')
