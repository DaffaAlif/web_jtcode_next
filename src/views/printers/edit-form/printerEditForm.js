...
const FormLayoutsEditPrinter = ({ handleClose, open, selectedData, dataSites, dataInstruments, handleFormChange, handleEdit }) => {
  return (
    <>
...
export default FormLayoutsEditPrinter
